...
export const unconfiguredProvider: HostingProvider = {
  ...
  capabilities,
  async searchDomain() {
    return notConfigured('Domain availability');
  },
  async provisionHosting() {
    return notConfigured('Hosting provisioning');
  },
  async getHostingUsage() {
    return notConfigured('Hosting usage');
  },
  async getControlPanelUrl() {
    return notConfigured('Hosting control panel');
  },
  async createMailbox() {
    return notConfigured('Email provisioning');
  },
  async getWebmailUrl() {
    return notConfigured('Webmail');
  },
};
