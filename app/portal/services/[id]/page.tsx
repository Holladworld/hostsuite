...
export default function ServiceManagementPage() {
  ...
  return <main className="min-h-screen bg-background px-4 py-8 sm:px-6 lg:px-8"><div className="mx-auto max-w-6xl">
    ...
    <section className="mt-7 grid gap-4 lg:grid-cols-[1.6fr_1fr]">
      <Card><CardHeader><CardTitle>Service management</CardTitle><CardDescription>Controls shown here are driven by the service type, saved order configuration and provider capabilities. Unsupported operations are not presented as working.</CardDescription></CardHeader><CardContent>
